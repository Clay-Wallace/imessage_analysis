...
def export_html_overview(
    ...
    html = HTML_TEMPLATE.format(
        ...
        total=f"{total:,}",
        mesg_sent=f"{mesg_sent:,}",
        percent_sent=percent_sent,
        num_recipients=f"{len(recipients):,}",
        mesg_received=f"{mesg_received:,}",
        percent_received=percent_received,
        num_senders=f"{len(senders):,}",
        unique_convos=f"{unique_convos:,}",
        num_group_chats=f"{len(group_chats):,}",
